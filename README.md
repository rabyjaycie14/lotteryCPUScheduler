...
# Supplied Test Programs
  ...
  # lotteryTest.c
    ...
    Note, there are two CPUs in xv6. You will need to create at least three subprocesses to test the
    lottery scheduler. In your report, you will should include at least the following tests:
